...
void main(void)
{
    ...
    while(1)
    {
        uint8_t rpm_byte=read_rpm();
        can_transmit(0x30,&rpm_byte,1);

        uint8_t indicator_byte=read_indicator();
        can_transmit(0x40,&indicator_byte,1);
