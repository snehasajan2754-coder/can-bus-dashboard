...
void handle_speed_data(uint8_t *data,uint8_t len)
{
    ...
    clcd_putch((speed/100)+'0',(0x80 + (8)));
    clcd_putch((speed/10)%10+'0',(0x80 + (9)));
    clcd_putch(speed%10+'0',(0x80 + (10)));
}
...
void handle_rpm_data(uint8_t *data,uint8_t len)
{
    ...
    clcd_print("RPM:     ",(0x80 + (0)));
    clcd_putch((rpm/1000)+'0',(0x80 + (4)));
    clcd_putch(((rpm/100)%10)+'0',(0x80 + (5)));
    clcd_putch(((rpm/10)%10)+'0',(0x80 + (6)));
    clcd_putch((rpm%10)+'0',(0x80 + (7)));
}

void handle_indicator_data(uint8_t *data,uint8_t len)
{
    clcd_print("ind:",(0xC0 + (0)));
